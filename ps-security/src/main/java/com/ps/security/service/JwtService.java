...
public class JwtService {
    ...
    @Value("${jwt.secret:" + SystemConstant.TOKEN_SECRET + "}")
    private String secret;

    @Value("${jwt.expire:" + SystemConstant.TOKEN_EXPIRE_TIME + "}")
    private Long expire;

    @Value("${jwt.refresh-expire:" + SystemConstant.REFRESH_TOKEN_EXPIRE_TIME + "}")
